...
<div class="startdiv">
	<form name="frmForm" class="_frmForm" id="_frmForm" method="post"
		...
		<div id="content" class="reviewcontent" name="content"
			style="width: 800px; overflow: scroll; height: 500px;"></div>
		<div align="right" style="width: 766px;">
			<%
				if (mem.getId().equals(dto.getId())) {
			%>
			<input type="button" value="글 수정"
				onclick="location.href='reviewupdate.do?seq=<%=dto.getSeq()%>'">
			<input type="button" value="글 삭제"
				onclick="deletereview('<%=dto.getSeq()%>')">
